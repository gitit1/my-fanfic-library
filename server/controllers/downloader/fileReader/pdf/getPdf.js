...
const { readPdf } = require('./readPdf.js');
const { fixStringForPath } = require('../../../helpers/fixStringForPath.js');
const funcs = require('../../helpers/index');
const keys = require("../../../../config/keys");

exports.getPdf = async (fandomName, filetype, fileName, deleted, req, res) => {
    return await new Promise(async function (resolve, reject) {
        ...
        await upload(req, res, async function (err) {
            ...
            await readPdf(fandomName, `${tempPath}/${fileName}.${filetype}`, deleted).then(async fanfic => {
