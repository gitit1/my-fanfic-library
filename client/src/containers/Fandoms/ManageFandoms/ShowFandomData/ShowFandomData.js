                      ...
                      <li key={fandom.Fandom_Name}>
                          ...
                          <section className={classes.DataSection}>
                            ...
                            <div className={classes.ButtonsSection}>
                                <Button clicked={props.editFandom}>Edit</Button>
                                <Button clicked={props.deleteFandom}>Delete</Button>
                            </div>       
                          </section>
