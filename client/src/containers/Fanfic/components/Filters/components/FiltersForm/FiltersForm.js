...
const Filters = (props) => {
    const { sort, source, filter, checked, getCategories, filteredCategories, isManager } = props;
    return (
        <div className={classes.Filters}>
            <form className={classes.Form} onSubmit={(event) => props.filtersAction(event)} autoComplete="off">
                ...
                <FanficsFilters {...{ classes, filtersArray, checked, filter, getCategories, filteredCategories, isManager }} />
