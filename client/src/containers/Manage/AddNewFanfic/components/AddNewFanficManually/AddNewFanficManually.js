...
class AddNewFanficManually extends Component {
    ...
    render() {
        ...
        const { loading, fanfic, size, similarFanfic, fileReaderFlag } = this.props;
            ...
            <div className='addNewFanficManually'>
                {showData === 0 ?
                    ...
                    <Grid container className='addNewFanficManually_content'>
                        ...
                        {((showUploadButton || (showSaveButton && (similarFanfic === null))) && !savedData && !fileReaderFlag) &&
                            <React.Fragment>
...
const mapDispatchedToProps = dispatch => {
    return {
        ...
        onGetFanficData: (type, fandomName, url, fanficForm) => dispatch(actions.getFanficData(type, fandomName, url, fanficForm)),
        ...
        onSaveFanficFromFile: (fandomName, fileName, formData) => dispatch(actions.saveFanficFromFile(fandomName, fileName, formData)),
    };
}
